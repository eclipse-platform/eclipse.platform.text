...
import org.eclipse.jface.text.preferences.AbstractPreferenceStoreProvider;
 ...
 */
class PreferenceStoreProviderDescriptor {
	 ...
	 */
	public PreferenceStoreProviderDescriptor(IConfigurationElement element) throws CoreException {
	 ...
	 * @param id            the id of the codemining provider.
	 ...
	 */
	protected IPreferenceStoreProvider createPreferenceStoreProvider(ITextEditor editor) {
		try {
			Object extension = fConfiguration.createExecutableExtension(CLASS_ATTRIBUTE);
			if (extension instanceof IPreferenceStoreProvider) {
				if (extension instanceof AbstractPreferenceStoreProvider) {
					((AbstractPreferenceStoreProvider) extension).setContext(editor);
				}
				return (IPreferenceStoreProvider) extension;
			} else {
	 ...
	 *         and false otherwise.
	 */
	public boolean matches(ITextViewer viewer, ITextEditor editor) {
